...
{?>
					  			...
					  			<p><?php echo htmlentities($num1);?> Reviews not Process yet</p>
                  		</div>
                      <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Review Status in process</p>
                      </div>
  <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Review has been done</p>
                      </div>
