...
<html lang="en">
    <head>
        ...
        <title>Prof-Rev| Dashboard</title>
...
<a href="manage-users.php">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <i class="mdi mdi-chart-areaspline widget-one-icon"></i>
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="Statistics">Users Listed</p>
<?php $query1=mysqli_query($conn,"select * from users");
